"""
Django settings for agro_hub project.
...
SECRET_KEY = 'django-insecure-f(+cri+6uowcz6d*xnc$clf837kil@rbwfg^dh5$r0-eiz961d'
...
WSGI_APPLICATION = 'agro_hub.wsgi.application'
